...
Hosted [on Espaces Marx's website](https://www.espaces-marx.eu/tools/lia-restoration) — or just open `lia-restoration.html` locally. No installation, no dependencies.
